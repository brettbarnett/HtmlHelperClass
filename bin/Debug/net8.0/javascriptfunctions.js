const hiddenColumns = ["Barcode", "CommodityID", "CommodityItemID", "PacksPerPallet", "Weight", "Description", "LotControlled", "MinQuantity", "MaxQuantity", "WarehouseMinQuantity", "WarehouseMaxQuantity", "UnitOfMeasure", "PartLabelFormat", "MaxULocQuantity", "DestinationsMandatory", "QuickAdded", "ActiveDate", "ObsoleteDate", "PartType", "Carryover", "ModelYear", "StackHeight", "SchedPack", "PartColor", "RepackContainer", "MRDGroup", "CustomerDLoc", "CustomerULoc", "HazmatCode", "ABCClassification", "UserText1", "UserText2", "UserText3", "CustomerDockCode", "PartCLIDeliveryLocation", "RepackStandardPackSize", "NextRevisionPart", "NextRevisionPartActive", "BulkPickCartLayer", "RepackSerialNumberCapture", "RepackTotesPerPallet", "MaxCasesPerDLOC", "MinULocQuantity", "PartExhaustFlag", "SystemDirectedRoutingCalculationMethod", "AllowRoutingCMAToULOC", "MaxStorageLevel", "ReplenishQtyRestriction", "CMAMissedPicksAllowed", "EngineeringChangeCompleted", "PriorRevisionPart", "TrailerStackHeight", "PartSupplierRequired", "CommodityItemCode", "QtyPerOrder"];
